...
export default function LifeJourneyBrown() {
  return (
    <section
      id="journey"
      data-section
      className="relative isolate overflow-hidden bg-[#140b08] px-6 py-28 text-[#f5eee6] sm:px-8 sm:py-32 lg:px-10"
    >
      <div className="absolute inset-0 bg-gradient-to-br from-[#140b08] via-[#2a140f] to-[#140b08]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(240,163,90,0.12),_transparent_28%),radial-gradient(circle_at_top_right,_rgba(193,91,42,0.12),_transparent_30%),radial-gradient(circle_at_bottom_right,_rgba(140,58,31,0.15),_transparent_30%)]" />
      ...
      <div className="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-[#f0a35a]/[0.02] to-transparent" />

      <motion.div
        className="absolute left-[-8%] top-[10%] h-[320px] w-[320px] rounded-full bg-[#f0a35a]/10 blur-[140px]"
        animate={{ x: [0, 18, -8, 0], y: [0, -18, 10, 0] }}
        transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute bottom-[-8%] right-[-8%] h-[360px] w-[360px] rounded-full bg-[#8c3a1f]/20 blur-[150px]"
        animate={{ x: [0, -20, 8, 0], y: [0, 18, -8, 0] }}
        transition={{ duration: 17, repeat: Infinity, ease: "easeInOut" }}
      />
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        >
          <motion.p
            variants={reveal}
            className={`inline-flex items-center gap-3 rounded-full border border-[#8c3a1f]/40 bg-[#5a2416]/20 px-5 py-2 text-[11px] uppercase tracking-[0.34em] text-[#c15b2a] backdrop-blur-xl ${inter.className}`}
          >
            <span className="h-2 w-2 rounded-full bg-[#f0a35a] shadow-[0_0_14px_rgba(240,163,90,0.8)]" />
            Divine Journey
          </motion.p>

          <motion.h2
            variants={reveal}
            className={`mt-6 text-5xl leading-[1.04] text-[#f5eee6] sm:text-6xl lg:text-[4.8rem] ${cinzel.className}`}
          >
            The sacred timeline of{" "}
            <span className="bg-gradient-to-r from-[#f0a35a] to-[#c15b2a] bg-clip-text text-transparent">
              His divine journey
            </span>
          </motion.h2>
          ...
          <motion.p
            variants={reveal}
            className={`mx-auto mt-7 max-w-3xl text-base leading-8 text-[#d6c2b3] sm:text-lg ${inter.className}`}
          >
          ...
          <motion.div
            ...
            className="mt-10 flex flex-wrap items-center justify-center gap-4"
          >
            <div className="rounded-full border border-[#8c3a1f]/30 bg-[#2a140f]/30 px-5 py-3 text-sm text-[#d6c2b3] backdrop-blur-xl">
              Spiritual Milestones
            </div>
            <div className="rounded-full border border-[#8c3a1f]/30 bg-[#2a140f]/30 px-5 py-3 text-sm text-[#d6c2b3] backdrop-blur-xl">
              Sacred Legacy
        ...
        <div className="relative mt-20">
          <div className="absolute left-6 top-0 h-full w-px bg-gradient-to-b from-transparent via-[#8c3a1f]/30 to-transparent md:left-1/2 md:-translate-x-1/2" />
          <div className="absolute left-6 top-10 h-[calc(100%-5rem)] w-px bg-gradient-to-b from-[#f0a35a]/0 via-[#f0a35a]/40 to-[#8c3a1f]/0 md:left-1/2 md:-translate-x-1/2" />
                ...
                >
                  ...
                  <div className={`relative pl-16 md:pl-0 ${rightSide ? "md:order-2 md:pl-12" : "md:order-1 md:pr-12"}`}>
                    <motion.div
                      ...
                      className="group relative"
                    >
                      <div className="absolute -inset-[1px] rounded-[2rem] bg-[linear-gradient(135deg,rgba(240,163,90,0.2),rgba(193,91,42,0.15),rgba(140,58,31,0.2))] opacity-70 blur-[2px]" />
                      <motion.div
                        variants={floatSlow}
                        animate="animate"
                        className="relative overflow-hidden rounded-[2rem] border border-[#8c3a1f]/30 bg-[#2a140f]/60 p-6 shadow-[0_22px_52px_rgba(20,11,8,0.6)] backdrop-blur-2xl"
                      >
                        <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(240,163,90,0.05),transparent_38%,rgba(140,58,31,0.1)_100%)] opacity-80" />
                        <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#f0a35a]/60 to-transparent opacity-0 transition duration-500 group-hover:opacity-100" />
                        <motion.div
                          className="absolute inset-y-0 left-[-35%] w-[32%] -skew-x-12 bg-gradient-to-r from-transparent via-[#f0a35a]/10 to-transparent"
                          animate={{ x: ["0%", "270%"] }}
                          transition={{ duration: 4.6, repeat: Infinity, repeatDelay: 2.8, ease: "easeInOut" }}
                        />
                        ...
                        <div className="relative z-10">
                          <div className="flex items-center gap-4">
                            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[linear-gradient(135deg,rgba(240,163,90,0.15),rgba(140,58,31,0.2))] ring-1 ring-[#8c3a1f]/40">
                              <div className="h-2.5 w-2.5 rounded-full bg-[#f0a35a] shadow-[0_0_16px_rgba(240,163,90,0.8)]" />
                            </div>
                            <span className={`rounded-full border border-[#8c3a1f]/40 bg-[#8c3a1f]/10 px-3 py-1.5 text-[11px] uppercase tracking-[0.32em] text-[#f0a35a] ${inter.className}`}>
                              {item.year}
                            </span>
                          </div>

                          <h3 className={`mt-5 text-2xl leading-tight text-[#f5eee6] sm:text-[1.9rem] ${cinzel.className}`}>
                            {item.title}
                          </h3>

                          <p className={`mt-4 max-w-xl text-sm leading-7 text-[#d6c2b3] sm:text-[15px] ${inter.className}`}>
                            {item.text}
                          </p>
                        </div>
                      </motion.div>
                    ...
                    <motion.div
                      className="absolute left-6 top-10 h-3 w-3 -translate-x-1/2 rounded-full bg-[#f0a35a] shadow-[0_0_20px_rgba(240,163,90,0.8)] md:left-auto md:right-[-2.45rem] md:top-1/2 md:-translate-y-1/2 md:translate-x-1/2"
                      animate={{ scale: [1, 1.25, 1], opacity: [0.8, 1, 0.8] }}
                      transition={{ duration: 2.6, repeat: Infinity, ease: "easeInOut", delay: index * 0.15 }}
                    />
                    {!rightSide && <div className="hidden md:block absolute right-[-2.45rem] top-1/2 h-px w-12 -translate-y-1/2 bg-gradient-to-r from-[#f0a35a]/60 to-transparent" />}
                    {rightSide && <div className="hidden md:block absolute left-[-2.45rem] top-1/2 h-px w-12 -translate-y-1/2 bg-gradient-to-l from-[#f0a35a]/60 to-transparent" />}
                  </div>
                </motion.div>
              );
            })}
